-- Данные в заявлении содержат ссылки на адреса, улицы, населенные пункты.
-- Они должны быть взяты из справочников и не могут быть пустыми.

INSERT INTO j_street (street_code, street_name) VALUES
(1, 'улица Садовая'),
(2, 'Невский проспект'),
(3, 'улица Стахановцев'),
(4, 'улица Гороховая'),
...
INSERT INTO j_university (university_id, university_name) VALUES
...
-- 01/000/000/0000
INSERT INTO j_country_struct (area_id, area_name) VALUES
('010000000000', 'Город'),
...
INSERT INTO j_passport_office (p_office_id, p_office_area_id, p_office_name) VALUES
...
INSERT INTO j_register_office (r_office_id, r_office_area_id, r_office_name) VALUES
